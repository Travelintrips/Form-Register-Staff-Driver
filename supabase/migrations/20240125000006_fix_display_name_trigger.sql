...
BEGIN
    ...
    -- Logging
    RAISE NOTICE 'handle_new_user → id=%, role_id=%, role=%, display_name=%', NEW.id, user_role_id, user_role, display_name;

    -- ❌ REMOVED: Jangan update raw_user_meta_data karena sudah dikirim dari frontend
    -- Field 'name' sudah ada di raw_user_meta_data dari signUp()
